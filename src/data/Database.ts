export const products = [
  ...
  },
  {
    ...
    price: 379.99 * 5.5,
    description:
      "O monitor gamer Alienware de 27 polegadas com taxa de atualização de 240Hz e tempo de resposta de 1ms oferece imagens ultra suaves. Ideal para gamers profissionais. Especificações técnicas: Tamanho: 27 polegadas, Resolução: 1920x2580 (Full HD), Taxa de atualização: 240Hz, Tempo de resposta: 1ms, Tipo de painel: IPS, Conectividade: 1x HDMI, 1x DisplayPort, Ajuste de altura, inclinação e rotação.",
